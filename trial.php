<?php
  include("db_conn.php");
         ...
         $query = "SELECT emp.*, GROUP_CONCAT(addr.type) AS type,
                  ...
                  <form class="form-inline" role="form" method="POST" action="db_test.php"
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                           ...
                           <?php if(isset($prefix) && $prefix=="Mr") echo "checked"; ?>
                            value="Mr"/>Mr</label>
                           <label class="radio-inline"><input type="radio" name="prefix" 
                            <?php if(isset($prefix) && $prefix=="Mrs") echo "checked"; ?>
                           value="Mrs"/>Mrs</label>
                        </div>
                     </div>
                     <div class="form-group">
