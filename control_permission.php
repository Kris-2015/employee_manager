...

{
    ...
    */
    ...
    /*
    *function to get the privilege of the resource
    */
    public function getprivilege($role_id, $resource_id)
    {
        $privilege = "SELECT rrp.role_id, rrp.resource_id, rrp.privilege_id, p.name FROM role_resource_privilege rrp
            INNER JOIN privilege p ON rrp.privilege_id = p.privilege_id
    ...
    /*
     *function to add new privilege of the user
    */
