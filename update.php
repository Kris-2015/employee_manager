               ...
               <div class="well well-lg">
                  <form class="form-inline" role="form" method="POST" action="db_test.php"
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fname" name="first_name" value="<?php echo (isset($user_data['first_name']) ? $user_data['first_name'] : '') ?>" />
                     </div>
                     <div class="form-group">
                        <label for="mname">Middle Name:</label>
                        <input type="text" class="form-control" id="mname" name="middle_name"
                        value="<?php echo (isset($user_data['first_name']) ? $user_data['middle_name'] : '') ?>" /> 	
                     </div>
                     <div class="form-group">
