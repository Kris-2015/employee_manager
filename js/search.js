         ...
         success: function(data) {
            ...
            for (var key in data) {
               if (data.hasOwnProperty(key)) {
                  arr_data += '<tr>';
                  arr_data += '<td><a href="#" class="u_name" data-github="'+data[key]["github_username"] +'" data-backdrop="static" data-keyboard="false" >' + data[key]["name"] + '</a></td>';
         ...
         success: function(result) {
            ...
            for (var key in result.data) {
               ...
               if (result.data.hasOwnProperty(key)) {
                  show_data += '<tr>';
                  show_data += '<td><a href="#" class="u_name" data-github="' + result.data[key]["github_username"] +'"> ' + result.data[key]["name"] + '</a></td>';
