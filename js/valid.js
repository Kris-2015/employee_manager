function valid()
	{
	    try {
		    ...
		    {
		    	console.log("in confirm_password pass condition " + confirm_password);return false;
		    ...
		    {
		    	login_mess = 'Please enter your email id';
		    }
		    else if(login_id.match(letters))
		    {
		    	login_mess = ' ';
		    }
		    else
		    {
		    	login_mess = 'Invalid login id ';
		    }
		    /*-----------------------------------------------------------------------*/
